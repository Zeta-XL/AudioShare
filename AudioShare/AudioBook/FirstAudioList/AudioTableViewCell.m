...
//    self.tagsLabel.backgroundColor = [UIColor blueColor];
    ...
    //
    self.tracksCountsLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMinX(_tagsLabel.frame), CGRectGetMaxY(_tagsLabel.frame) + 10, 70, CGRectGetHeight(_tagsLabel.frame))];
...
-(void)layoutSubviews
{
    ...
    _tracksCountsLabel.frame = CGRectMake(CGRectGetMinX(_tagsLabel.frame), CGRectGetMaxY(_tagsLabel.frame) + 10, 70, CGRectGetHeight(_tagsLabel.frame));
    _timeLabel.frame = CGRectMake(CGRectGetMaxX(_tracksCountsLabel.frame)+5, CGRectGetMinY(_tracksCountsLabel.frame), 60, CGRectGetHeight(_tracksCountsLabel.frame));
}
