...
- (void)p_setUpView
{
    ...
    _albumImageView.frame = CGRectMake(0, 0, self.contentView.bounds.size.width, self.contentView.bounds.size.height * 0.75);
    ...
    _albumTitleLabel.frame = CGRectMake(0, CGRectGetMaxY(_albumImageView.frame), CGRectGetWidth(_albumImageView.frame) * 0.75, self.contentView.bounds.size.height * 0.25);
